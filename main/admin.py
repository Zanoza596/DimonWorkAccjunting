...
class OperationsCategorysAdmin(admin.ModelAdmin):
    prepopulated_fields={'slug':('name',)} 
    list_display=['name','parent','note','slug']
    list_editable=['note','parent','slug']
...
class OperationsAdmin(admin.ModelAdmin):
    prepopulated_fields={'slug':('name',)}  
    list_display=['name','time','unit','cost','category','equipment','salary','amortization','note','slug']
    list_editable=['time','unit','cost','category','equipment','salary','amortization','note','slug']
    search_fields=['familyName','name','secondName','enterprise','dateOfBirth','address','telephones','photo','note','slug']
    list_filter=['name','time','unit','cost','category','equipment','salary','amortization','note','slug']
    fields=['name','time','unit','cost','category','equipment','salary','amortization','note','slug']
